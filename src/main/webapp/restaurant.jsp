<%--@elvariable id="restaurant" type="me.bnnq.labwork.models.Hotel"--%>
    ...
    <div class="container-fluid min-vh-100 px-0">
        <div class="row bg-black">
            <div class="col-7 m-auto bg-image"
                 style="min-height: 350px; background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.9)), url(${restaurant.images[0]});">
            <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row no-gutters pr-md-5 text-light">
                            ...
                            <div class="col-12 my-1">
                                ...
                                <a class="link-secondary" href="${restaurant.link}">${restaurant.link}</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="slick-carousel">
                        <c:forEach var="image" items="${restaurant.images}">
                            <img src="${image}" class="img-fluid" style="max-height: 400px" alt="...">
                        </c:forEach>
                    </div>
                </div>
            </div>
